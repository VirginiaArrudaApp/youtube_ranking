...
export default function Videos() {
    const { data, error, isLoading } = useFetch<VideoSchema[]>();
        ...
        <>
            <Container>
                <div className="mb-6 xl:mb-10">
                    <Title heading="h1" className="mb-4"> Vídeos do mês </Title>
                ...
                <div className="flex flex-col gap-10">
                    {!!data?.filter((video: VideoSchema) => video.week === 4).length && (
                        <div>
                            <Title heading="h2" className="mb-6"> Última semana </Title>
                    ...
                    {!!data?.filter((video: VideoSchema) => video.week === 3).length && (
                        <div>
                            <Title heading="h2" className="mb-6"> Terceira semana </Title>
                    ...
                    {!!data?.filter((video: VideoSchema) => video.week === 2).length && (
                        <div>
                            <Title heading="h2" className="mb-6"> Segunda semana </Title>
                    ...
                    {!!data?.filter((video: VideoSchema) => video.week === 1).length && (
                        <div>
                            <Title heading="h2" className="mb-6"> Primeira semana </Title>
